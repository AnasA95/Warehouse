...
urlpatterns = [
    ...
    url(r'^owner/$', views.OwnerList.as_view(), name='owner-list'),
    ...
    url(r'^incomingOrder/$', views.IncomingOrderList.as_view(), name='incomingorder-list'),
    url(r'^incomingOrder/(?P<pk>[0-9]+)/$', views.IncomingOrderDetail.as_view()),
    url(r'^outgoingOrder/$', views.OutgoingOrderList.as_view(), name='outgoingorder-list'),
    url(r'^outgoingOrder/(?P<pk>[0-9]+)/$', views.OutgoingOrderDetail.as_view()),
    url(r'^package/$', views.PackageList.as_view(), name='package-list'),
    url(r'^package/(?P<pk>[0-9]+)/$', views.PackageDetail.as_view()),
    url(r'^box/$', views.BoxList.as_view(), name='box-list'),
